            ...
            <div class="col-md-4">
                ...
                <div class="form-group">
                    ...
                    <select name="kategori" class="form-control">
                        ...
                        ?>
                                <option value="<?php echo $satir_kat['kategori']; ?>"><?php echo $satir_kat['kategori']; ?></option>
                        <?php
                            }
                        }
                        ?>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="tarih" class="form-control" value="<?php echo $satir_duzenle['tarih']; ?>">
                </div>
                <div class="form-group">
                ...
                if ($_POST) {
                    ...
                    if(move_uploaded_file($_FILES['foto']['tmp_name'],$yuklenecekfoto)){
                        ...
                        if($sorgu_guncelle -> rowCount()){
                            echo '<div class="alert alert-success">Yazı Güncellendi</div><meta http-equiv="refresh" content="2; url=yazilar.php">';
                        } else {
