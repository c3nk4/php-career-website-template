        ...
        <form method="post" class="form-row" enctype="multipart/form-data">
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" name="adres" id="adres" class="form-control" value="<?php echo $satir_menu['adres']; ?>">
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    <label for="telefon"><small>Telefon</small></label>
                    <input type="tel" name="telefon" id="telefon" class="form-control" value="<?php echo $satir_menu['telefon']; ?>"> 
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    <label for="email"><small>E-Posta</small></label>
                    <input type="email" name="email" id="email" class="form-control" value="<?php echo $satir_menu['email']; ?>">
                </div>
            </div>
            <div class="col-md-9">
                <div class="form-group">
                    <label for="harita"><small>Harita (Google Maps)</small></label>
                    <textarea name="harita" id="harita" rows="5" class="form-control"><?php echo $satir_menu['harita']; ?></textarea>
                </div>
            </div>
            <div class="col-md-3">
                <div class="form-group">
                    <label for="tanitim"><small>Kısa Tanıtım Yazısı</small></label>
                    <textarea name="tanitim" id="tanitim" rows="5" class="form-control"><?php echo $satir_menu['tanitim']; ?></textarea>
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    <label for="logo"><small>Logo Ekle</small></label>
                    <input type="file" name="logo" id="logo" value="<?php echo $satir_menu['logo']; ?>">
                </div>
                <div class="form-group">
                    <input type="text" name="fotoalt1" class="form-control" placeholder="Foto Alt Metni Girin" value="<?php echo $satir_menu['fotoalt1']; ?>">
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    <label for="blogbanner"><small>Blog Sayfası Banner</small></label>
                    <input type="file" name="blogbanner" id="blogbanner"  value="<?php echo $satir_menu['blogbanner']; ?>">
                </div>
                <div class="form-group">
                    <input type="text" name="fotoalt2" class="form-control" placeholder="Foto Alt Metni Girin"  value="<?php echo $satir_menu['fotoalt2']; ?>">
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    <label for="iletisimbanner"><small>İletişim Sayfası Banner</small></label>
                    <input type="file" name="iletisimbanner" id="iletisimbanner"  value="<?php echo $satir_menu['iletisimbanner']; ?>">
                </div>
                <div class="form-group">
                    <input type="text" name="fotoalt3" class="form-control" placeholder="Foto Alt Metni Girin"  value="<?php echo $satir_menu['fotoalt3']; ?>">
                </div>
            </div>
            <div class="col-md-3">
                <div class="form-group">
                    <label for="facebook"><small>Facebook Profili</small></label>
                    <input type="text" name="facebook" id="facebook" class="form-control" value="<?php echo $satir_menu['facebook']; ?>">
                </div>
            </div>
            <div class="col-md-3">
                <div class="form-group">
                    <label for="instagram"><small>Instagram Profili</small></label>
                    <input type="text" name="instagram" id="instagram" class="form-control"  value="<?php echo $satir_menu['instagram']; ?>">
                </div>
            </div>
            <div class="col-md-3">
                <div class="form-group">
                    <label for="twitter"><small>Twitter Profili</small></label>
                    <input type="text" name="twitter" id="twitter" class="form-control"  value="<?php echo $satir_menu['twitter']; ?>">
                </div>
            </div>
            <div class="col-md-3">
                <div class="form-group">
                    <label for="whatsapp"><small>Whatsapp Profili</small></label>
                    <input type="text" name="whatsapp" id="whatsapp" class="form-control"  value="<?php echo $satir_menu['whatsapp']; ?>">
                </div>
            </div>
            <div class="col-9">
                <div class="form-group">
                    <input type="text" name="copy" id="copy" class="form-control" placeholder="Her Hakkı Saklıdır" value="<?php echo $satir_menu['copy']; ?>">
                </div>
            </div>
