...
<section id="sayfalar" class="py-4">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h2>Sayfa Ekle</h2>
        ...
        <form class="form-row" method="post" enctype="multipart/form-data">
            <div class="col-md-8">
                <div class="form-group">
                    <input type="text" name="baslik" class="form-control" placeholder="Sayfa Başlığı Girin">
                </div>
                <div class="form-group">
                    <textarea name="icerik" rows="7" class="form-control" placeholder="Sayfa İçeriği Girin"></textarea>
                    <script>
            ...
            <div class="col-md-4">
                ...
                <div class="form-group">
                    <input type="text" name="fotoalt" class="form-control" placeholder="Görsel Alt Metni Girin">
                </div>
                <div class="form-group">
